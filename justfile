...
check:
    ...
    O11YFLEET_API_URL=http://localhost:8787 RUN_ID=local-check JOB_INDEX=0 INSTANCE=0 GLOBAL_INDEX=0 scripts/generate-opamp-supervisor-config.sh runtime/check-supervisor.yaml fp_enroll_test-token
    test -s runtime/check.yaml
    test -s runtime/check-supervisor.yaml
